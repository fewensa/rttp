...
fn typed_request_helpers_reject_malformed_values_before_connect() {
  ...
  reject_before_connect("unknown ECT", |client| client.ect("5g"));
  reject_before_connect("ECT list", |client| client.ect("3g, 4g"));
  reject_before_connect("ECT with control byte", |client| client.ect("3g\0"));
  reject_before_connect("oversized ECT", |client| {
    client.ect("3".repeat(64 * 1024 + 1))
  });
}
