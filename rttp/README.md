...
client path also includes rejection of request bodies for GET, HEAD, DELETE,
...
decoding, large header blocks via CONTINUATION frames, padded incoming response
