...
pub use rttp_client::{
  ...
  SecChUaBitnessParseError, SecChUaMobile, SecChUaMobileParseError, SecChUaModel,
  SecChUaModelParseError, SecChUaPlatform, SecChUaPlatformParseError, SecChUaWow64,
  SecChUaWow64ParseError, SecFetchDest, SecFetchMode, SecFetchSite, SecFetchUser, SecPurpose,
