...
pub use rttp_client::{
  ...
  SecChUaBitnessParseError, SecChUaMobile, SecChUaMobileParseError, SecChUaPlatform,
  SecChUaPlatformParseError, SecFetchDest, SecFetchMode, SecFetchSite, SecFetchUser, SecPurpose,
