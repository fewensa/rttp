...
#[test]
fn test_conflicting_content_length_response_is_rejected() {
  let (addr, _handle) = support::spawn_chunked_response_server(concat!(
    "HTTP/1.1 200 OK\r\n",
    "Content-Length: 2\r\n",
    "Content-Length: 3\r\n",
...
#[test]
fn test_http11_connection_ows_close_forces_fresh_socket() {
...
#[test]
fn test_http11_connection_ows_keep_alive_reuses_socket() {
  let (addr, handle) = support::spawn_redirect_connection_reuse_probe_server(
...
#[test]
fn test_http10_connection_ows_keep_alive_reuses_socket() {
...
#[test]
fn test_http11_connection_raw_obs_text_close_padding_still_reuses_socket() {
...
#[test]
fn test_http10_connection_raw_obs_text_keep_alive_padding_forces_fresh_socket() {
  let mut connection = b"Connection:".to_vec();
  connection.push(0xa0);
...
#[test]
fn test_connection_header_preserves_raw_obs_text_padding() {
  let mut response = b"HTTP/1.1 200 OK\r\nContent-Length: 2\r\nConnection:".to_vec();
  response.push(0xa0);
...
#[test]
fn test_connection_header_ows_close_still_closes_client() {
  let (addr, _handle) = support::spawn_chunked_response_server(concat!(
    "HTTP/1.1 200 OK\r\n",
    "Content-Length: 2\r\n",
    "Connection: \t close \t\r\n",
