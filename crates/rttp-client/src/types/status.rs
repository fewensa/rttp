...
///
/// IANA maintains the [Hypertext Transfer Protocol (HTTP) Status Code
...
status_codes! {
    /// 100 Continue
    /// [[RFC7231, Section 6.2.1](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.2.1)]
    (100, CONTINUE, "Continue");
    /// 101 Switching Protocols
    /// [[RFC7231, Section 6.2.2](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.2.2)]
    ...
    /// 200 OK
    /// [[RFC7231, Section 6.3.1](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.3.1)]
    (200, OK, "OK");
    /// 201 Created
    /// [[RFC7231, Section 6.3.2](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.3.2)]
    (201, CREATED, "Created");
    /// 202 Accepted
    /// [[RFC7231, Section 6.3.3](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.3.3)]
    (202, ACCEPTED, "Accepted");
    /// 203 Non-Authoritative Information
    /// [[RFC7231, Section 6.3.4](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.3.4)]
    (203, NON_AUTHORITATIVE_INFORMATION, "Non Authoritative Information");
    /// 204 No Content
    /// [[RFC7231, Section 6.3.5](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.3.5)]
    (204, NO_CONTENT, "No Content");
    /// 205 Reset Content
    /// [[RFC7231, Section 6.3.6](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.3.6)]
    (205, RESET_CONTENT, "Reset Content");
    /// 206 Partial Content
    /// [[RFC7233, Section 4.1](https://www.rfc-editor.org/rfc/rfc7233.html#section-4.1)]
    (206, PARTIAL_CONTENT, "Partial Content");
    /// 207 Multi-Status
    /// [[RFC4918](https://www.rfc-editor.org/rfc/rfc4918.html)]
    (207, MULTI_STATUS, "Multi-Status");
    /// 208 Already Reported
    /// [[RFC5842](https://www.rfc-editor.org/rfc/rfc5842.html)]
    (208, ALREADY_REPORTED, "Already Reported");

    /// 226 IM Used
    /// [[RFC3229](https://www.rfc-editor.org/rfc/rfc3229.html)]
    (226, IM_USED, "IM Used");

    /// 300 Multiple Choices
    /// [[RFC7231, Section 6.4.1](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.4.1)]
    (300, MULTIPLE_CHOICES, "Multiple Choices");
    /// 301 Moved Permanently
    /// [[RFC7231, Section 6.4.2](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.4.2)]
    (301, MOVED_PERMANENTLY, "Moved Permanently");
    /// 302 Found
    /// [[RFC7231, Section 6.4.3](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.4.3)]
    (302, FOUND, "Found");
    /// 303 See Other
    /// [[RFC7231, Section 6.4.4](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.4.4)]
    (303, SEE_OTHER, "See Other");
    /// 304 Not Modified
    /// [[RFC7232, Section 4.1](https://www.rfc-editor.org/rfc/rfc7232.html#section-4.1)]
    (304, NOT_MODIFIED, "Not Modified");
    /// 305 Use Proxy
    /// [[RFC7231, Section 6.4.5](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.4.5)]
    (305, USE_PROXY, "Use Proxy");
    /// 307 Temporary Redirect
    /// [[RFC7231, Section 6.4.7](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.4.7)]
    (307, TEMPORARY_REDIRECT, "Temporary Redirect");
    /// 308 Permanent Redirect
    /// [[RFC7238](https://www.rfc-editor.org/rfc/rfc7238.html)]
    (308, PERMANENT_REDIRECT, "Permanent Redirect");

    /// 400 Bad Request
    /// [[RFC7231, Section 6.5.1](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.5.1)]
    (400, BAD_REQUEST, "Bad Request");
    /// 401 Unauthorized
    /// [[RFC7235, Section 3.1](https://www.rfc-editor.org/rfc/rfc7235.html#section-3.1)]
    (401, UNAUTHORIZED, "Unauthorized");
    /// 402 Payment Required
    /// [[RFC7231, Section 6.5.2](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.5.2)]
    (402, PAYMENT_REQUIRED, "Payment Required");
    /// 403 Forbidden
    /// [[RFC7231, Section 6.5.3](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.5.3)]
    (403, FORBIDDEN, "Forbidden");
    /// 404 Not Found
    /// [[RFC7231, Section 6.5.4](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.5.4)]
    (404, NOT_FOUND, "Not Found");
    /// 405 Method Not Allowed
    /// [[RFC7231, Section 6.5.5](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.5.5)]
    (405, METHOD_NOT_ALLOWED, "Method Not Allowed");
    /// 406 Not Acceptable
    /// [[RFC7231, Section 6.5.6](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.5.6)]
    (406, NOT_ACCEPTABLE, "Not Acceptable");
    /// 407 Proxy Authentication Required
    /// [[RFC7235, Section 3.2](https://www.rfc-editor.org/rfc/rfc7235.html#section-3.2)]
    (407, PROXY_AUTHENTICATION_REQUIRED, "Proxy Authentication Required");
    /// 408 Request Timeout
    /// [[RFC7231, Section 6.5.7](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.5.7)]
    (408, REQUEST_TIMEOUT, "Request Timeout");
    /// 409 Conflict
    /// [[RFC7231, Section 6.5.8](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.5.8)]
    (409, CONFLICT, "Conflict");
    /// 410 Gone
    /// [[RFC7231, Section 6.5.9](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.5.9)]
    (410, GONE, "Gone");
    /// 411 Length Required
    /// [[RFC7231, Section 6.5.10](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.5.10)]
    (411, LENGTH_REQUIRED, "Length Required");
    /// 412 Precondition Failed
    /// [[RFC7232, Section 4.2](https://www.rfc-editor.org/rfc/rfc7232.html#section-4.2)]
    (412, PRECONDITION_FAILED, "Precondition Failed");
    /// 413 Payload Too Large
    /// [[RFC7231, Section 6.5.11](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.5.11)]
    (413, PAYLOAD_TOO_LARGE, "Payload Too Large");
    /// 414 URI Too Long
    /// [[RFC7231, Section 6.5.12](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.5.12)]
    (414, URI_TOO_LONG, "URI Too Long");
    /// 415 Unsupported Media Type
    /// [[RFC7231, Section 6.5.13](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.5.13)]
    (415, UNSUPPORTED_MEDIA_TYPE, "Unsupported Media Type");
    /// 416 Range Not Satisfiable
    /// [[RFC7233, Section 4.4](https://www.rfc-editor.org/rfc/rfc7233.html#section-4.4)]
    (416, RANGE_NOT_SATISFIABLE, "Range Not Satisfiable");
    /// 417 Expectation Failed
    /// [[RFC7231, Section 6.5.14](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.5.14)]
    (417, EXPECTATION_FAILED, "Expectation Failed");
    /// 418 I'm a teapot
    /// [curiously not registered by IANA but [RFC2324](https://www.rfc-editor.org/rfc/rfc2324.html)]
    ...
    /// 425 Too Early
    /// [[RFC8470](https://www.rfc-editor.org/rfc/rfc8470.html)]
    (425, TOO_EARLY, "Too Early");

    /// 426 Upgrade Required
    /// [[RFC7231, Section 6.5.15](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.5.15)]
    ...
    /// [[RFC7231, Section 6.6.1](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.6.1)]
    (500, INTERNAL_SERVER_ERROR, "Internal Server Error");
    /// 501 Not Implemented
    /// [[RFC7231, Section 6.6.2](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.6.2)]
    (501, NOT_IMPLEMENTED, "Not Implemented");
    /// 502 Bad Gateway
    /// [[RFC7231, Section 6.6.3](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.6.3)]
    (502, BAD_GATEWAY, "Bad Gateway");
    /// 503 Service Unavailable
    /// [[RFC7231, Section 6.6.4](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.6.4)]
    (503, SERVICE_UNAVAILABLE, "Service Unavailable");
    /// 504 Gateway Timeout
    /// [[RFC7231, Section 6.6.5](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.6.5)]
    (504, GATEWAY_TIMEOUT, "Gateway Timeout");
    /// 505 HTTP Version Not Supported
    /// [[RFC7231, Section 6.6.6](https://www.rfc-editor.org/rfc/rfc7231.html#section-6.6.6)]
    (505, HTTP_VERSION_NOT_SUPPORTED, "HTTP Version Not Supported");
    /// 506 Variant Also Negotiates
    /// [[RFC2295](https://www.rfc-editor.org/rfc/rfc2295.html)]
    ...
    /// 510 Not Extended
    /// [[RFC2774](https://www.rfc-editor.org/rfc/rfc2774.html)]
    (510, NOT_EXTENDED, "Not Extended");
    /// 511 Network Authentication Required
    /// [[RFC6585, Section 6](https://www.rfc-editor.org/rfc/rfc6585.html#section-6)]
