...
pub use rttp_protocol::client_hints::{
  ...
  SecChUaMobile, SecChUaMobileParseError, SecChUaPlatform, SecChUaPlatformParseError, SecChUaWow64,
  SecChUaWow64ParseError, ViewportWidth, ViewportWidthParseError, Width, WidthParseError,
};
