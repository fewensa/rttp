...
The helper is metadata-only. `rttp_client` does not change outbound `Referer`
behavior, follow redirects, enforce browser referrer policy, or attach
referrer semantics to requests.
