...
pub use rttp_protocol::client_hints::{
  ...
  SecChUaPlatformParseError as HttpSecChUaPlatformParseError, SecChUaArch as HttpSecChUaArch,
  SecChUaArchParseError as HttpSecChUaArchParseError, ViewportWidth as HttpViewportWidth,
...
impl Request {
  ...
  /// without inferring an architecture, negotiating the UA brands family, or
  /// emitting Client Hints.
