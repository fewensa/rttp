...
singleton `Sec-CH-UA-Arch` request Client Hint into `HttpSecChUaArch`, accepting
one Structured Fields string after optional SP or HTAB trimming and exposing
canonical quoted-string text through `header_value()`. Empty, non-string,
